    ...
    return (
        <div>
          <div className='flex justify-between p-4'>
                  ...
                  <Link className='px-3 py-[6px] bg-purple-500 rounded-sm text-white hover:bg-purple-600' to='/dashboard/operations/add'>Ajoute Opération</Link>
                </div>
                ...
                <table className="w-full text-sm text-left text-slate-600">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th className="px-7 py-3">Limites prestastion</th>
                            ...
                            inspections
                                ...
                                .map((n, i) => (
                                    <tr key={i} className="bg-white border-b">
                                        ...
                                        <td className="px-6 py-4">{n.prixUnit}{'m²'}</td>
                                        <td className="px-6 py-4">
                                            {n.tVa}{'%'}
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex justify-start items-center gap-x-4 text-white">
                                                
                                                {
                                                   ...
                                                   <Link to={`/dashboard/operations/edit/${n._id}`} className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50">
                                                    <FaEdit />
                                                </Link>
